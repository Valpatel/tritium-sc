...
class Commander:
    ...
    def __init__(
        ...
        # Model router (fleet-aware or None for static)
    ...
    def save_photo(self, reason: str) -> str | None:
        ...
        # Save photos to <project_root>/data/amy/photos/
        _project_root = os.path.join(os.path.dirname(__file__), "..", "..")
        photos_dir = os.path.join(_project_root, "data", "amy", "photos")
    ...
    def run(self) -> None:
        ...
        if self.curiosity_timer is not None:
            ...
            while self._running:
                ...
                if event.type == EventType.SHUTDOWN:
                    ...
                    if self.vision_thread and self.vision_thread.person_target is None:
                        from .actions.motor import search_scan
                        ptz = self.primary_ptz
                    ...
                    if (self.vision_thread
                        ...
                        if pan != 0 or tilt != 0:
                            from .actions.motor import MotorCommand
                            def _snap():
                                yield MotorCommand(
