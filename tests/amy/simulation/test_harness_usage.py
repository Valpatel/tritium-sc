...
from tests.amy.simulation.test_harness import SimulationTestHarness
...
class TestGameLifecycle:
    ...
    def test_setup_to_countdown(self):
        ...
        from tests.amy.simulation.test_harness import GameTestHarness
        h = GameTestHarness()
        h.place_friendly("turret-1", 0, 0, "turret")
    ...
    def test_difficulty_scaling(self):
        ...
        from amy.simulation.game_mode import WAVE_CONFIGS
