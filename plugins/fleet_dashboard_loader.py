...
re-exports FleetDashboardPlugin so it's discoverable without modifying
...
from fleet_dashboard.plugin import FleetDashboardPlugin  # noqa: E402, F401

__all__ = ["FleetDashboardPlugin"]
