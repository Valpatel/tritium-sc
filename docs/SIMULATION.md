...
Layout files define the static starting state of a neighborhood. The loader (`src/engine/simulation/loader.py`) reads these at boot and populates the simulation engine.
